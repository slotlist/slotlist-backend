...
export const missionSlotTemplate = [
    {
        ...
        config: {
            ...
            'pagination has to be used to retrieve the rest. Regular authentication is required to access this endpoint',
    ...
    },
    {
        ...
        config: {
            ...
            notes: 'Creates a new mission slot template with the provided data, optionally already creating slot groups and slots. Regular authentication is required to ' +
    ...
    },
    {
        ...
        config: {
            ...
            notes: 'Returns details of a mission slot template, including a full slot group and slot list. Regular authentication is required to access this endpoint',
            ...
            validate: {
                ...
                params: Joi.object().required().keys({
                    slotTemplateUid: Joi.string().guid().length(36).required().description('UID of the misison slot template').example('e3af45b2-2ef8-4ece-bbcc-13e70f2b68a8')
                })
            },
            response: {
                schema: Joi.object().required().keys({
