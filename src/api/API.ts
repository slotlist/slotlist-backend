...
export class API {
    ...
    private setAdditionalHeaders(request: Hapi.Request, reply: Hapi.ReplyWithContinue): any {
        ...
        if (!_.isNil(response) && response.isBoom && !_.isNil(response.output)) {
            ...
            response.output.headers['Public-Key-Pins-Report-Only'] = 'pin-sha256="3kcNJzkUJ1RqMXJzFX4Zxux5WfETK+uL6Viq9lJNn4o="; pin-sha256="CfyancXuwYEHYRX3mmLJI3NFW6E8cydaCGS1D9wGhT4="; pin-sha256="58qRu/uxh4gFezqAcERupSkRYBlBAvfcw7mEjGPLnNU="; pin-sha256="grX4Ta9HpZx6tSHkmCrvpApTQGo67CYDnvprLg5yRME="; pin-sha256="YLh1dUR9y6Kja30RrAn7JKnbQG/uEtLMkBgFF2Fuihg="; pin-sha256="sRHdihwgkaib1P1gxX8HFszlD+7/gTfNvuAybgLPNis="; pin-sha256="cZmxAdzqR6QocykhA1KF2BUd4fSAAJBEL9pjp+XA5KY="; pin-sha256="RMmFr2hUG/lUONYDT+SrgzlBlraKipm/DJufF9m/l9U="; pin-sha256="O84tZY/nc8vz0MfbCS8bInyGHhh8jB6WP3reOtSVCm0="; pin-sha256="Ls+kEewW0AVmx+oHvP2VhHkV5mNX4AyBOnbXbY1l32w="; max-age=604800; includeSubdomains; report-uri=https://morpheusxaut.report-uri.io/r/default/hpkp/reportOnly;';
        } else if (!_.isNil(response)) {
            response.header('Referrer-Policy', 'no-referrer-when-downgrade');
            // tslint:disable-next-line:max-line-length
            response.header('Public-Key-Pins-Report-Only', 'pin-sha256="3kcNJzkUJ1RqMXJzFX4Zxux5WfETK+uL6Viq9lJNn4o="; pin-sha256="CfyancXuwYEHYRX3mmLJI3NFW6E8cydaCGS1D9wGhT4="; pin-sha256="58qRu/uxh4gFezqAcERupSkRYBlBAvfcw7mEjGPLnNU="; pin-sha256="grX4Ta9HpZx6tSHkmCrvpApTQGo67CYDnvprLg5yRME="; pin-sha256="YLh1dUR9y6Kja30RrAn7JKnbQG/uEtLMkBgFF2Fuihg="; pin-sha256="sRHdihwgkaib1P1gxX8HFszlD+7/gTfNvuAybgLPNis="; pin-sha256="cZmxAdzqR6QocykhA1KF2BUd4fSAAJBEL9pjp+XA5KY="; pin-sha256="RMmFr2hUG/lUONYDT+SrgzlBlraKipm/DJufF9m/l9U="; pin-sha256="O84tZY/nc8vz0MfbCS8bInyGHhh8jB6WP3reOtSVCm0="; pin-sha256="Ls+kEewW0AVmx+oHvP2VhHkV5mNX4AyBOnbXbY1l32w="; max-age=604800; includeSubdomains; report-uri=https://morpheusxaut.report-uri.io/r/default/hpkp/reportOnly;');
        }
