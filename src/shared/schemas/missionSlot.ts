...
export const missionSlotDetailsSchema = missionSlotSchema.keys({
...
}).required().label('MissionSlotDetails').description('Detailed public mission slot information, as displayed in slotlists. Includes more detailed description.');
